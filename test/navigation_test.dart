...
void main() {
  testWidgets('ThemeData buildAppTextTheme() test', (WidgetTester tester) async {
  ...
  testWidgets('Alert test', (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(
          textTheme: buildAppTextTheme(),
  ...
  testWidgets('Internet connection Overlay', (WidgetTester tester) async {
